...
\longnewglossaryentry{burn-candle}
...
{%
	...
	make (something) into a parcels by wrapping it.\\
...
{name={adjoint}}
{%
	relating to ro denoting a function or quantity related to a given function or quantity by particular process of transposition.\\
...
{name={alter}}
{%
	change in character or composition, typicaly in a comparatively small but significant way.\\
